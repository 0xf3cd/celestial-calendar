...
2. emit-cpp            Emit C++ rows matching `YTLIU0_ROWS`. Prefer
   `--ytliu0 <checkout>` (decodes GOLDEN_YEARS from calendarData.js). Optional
   `--sample` frozen markdown is an author shortcut.
...
GOLDEN_YEARS = (1603, 1607, 1618, 1625, 1633, 1639, 1647, 1652, 1656, 1660, 1666, 1669, 1674, 1678, 1681, 1688, 1692, 1696, 1700, 1705, 1710, 1713, 1717, 1722, 1725, 1730, 1734, 1737, 1741, 1745, 1749, 1752, 1756, 1761, 1765, 1769, 1773, 1776, 1782, 1786, 1792, 1795, 1800, 1805, 1808, 1812, 1816, 1819, 1823, 1827, 1832, 1835, 1839, 1844, 1847, 1851, 1855, 1858, 1863, 1867, 1871, 1874, 1878, 1883, 1886, 1890, 1894, 1900, 1901, 2099, 2100, 2101, 2103, 2105, 2108, 2110, 2112, 2115, 2117, 2120, 2122, 2124, 2127, 2129, 2131, 2133, 2135, 2137, 2140, 2142, 2144, 2147, 2149, 2151, 2154, 2156, 2159, 2161, 2163, 2165, 2167, 2169, 2171, 2172, 2175, 2177, 2180, 2182, 2184, 2187, 2189, 2191, 2194, 2196, 2199)
...
def cmd_emit_cpp(args: argparse.Namespace) -> int:
  ...
  if args.ytliu0:
    ...
    if args.include_2099:
      row_2099 = extract_ytliu0_year(2099, None)  # will SystemExit without --ytliu0
