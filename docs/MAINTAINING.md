...
ref; other refs are skipped. Do not dispatch a modified workflow definition from an untrusted ref.
...
writes its App token into the origin URL in `.git/config` and attempts token revocation afterward.
